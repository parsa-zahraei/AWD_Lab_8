...
def create_quiz():
    ...
    # TODO: Initialize an instance of QuizService
    service = QuizService()

    # INCOMPLETE: Retrieve JSON data from the request
    # TODO: Get JSON data from the request using request.json
    data = request.get_json()

    if ((data.get('title') is None) or (data.get('questions') is None)):
        return jsonify({"error":
                        "Incorrect submission of quiz title \
                        and questions"}), 400

    # INCOMPLETE: Call the create_quiz method in the service
    # TODO: Use the service to create a quiz with the `data`
    ...
    # TODO: Use jsonify to create a JSON response containing `message`
    # and `quiz_id`, with status code 201
...
def get_quiz(quiz_id):
    # INCOMPLETE: Initialize the QuizService
    # TODO: Initialize an instance of QuizService
    # (Hint: service = QuizService())
    service = QuizService()

    # INCOMPLETE: Use the service to retrieve the quiz by its ID
    # TODO: Call the `get_quiz` method with `quiz_id` and
    # store the result in `quiz`
...
def submit_quiz(quiz_id):
    ...
    # INCOMPLETE: Use the service to evaluate the quiz with
    # the provided answers
    # TODO: Call `evaluate_quiz` with `quiz_id` and `user_answers`
    # and store the result in `score` and `message`
    ...
    # TODO: If `score` is None, return an error with status 404.
